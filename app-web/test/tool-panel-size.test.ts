...
import { computeEffectiveWidth, clampPanelWidth, clampPanelLayout, LEFT_ICONS_WIDTH, MIN_REMAINING_MAIN_AREA, PANEL_MIN, PANEL_MIN_LEFT, RIGHT_ICONS_WIDTH, TOP_TOOLS_MIN } from "../src/machine/tool-panels/tool-panel-size";
