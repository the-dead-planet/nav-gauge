...
import { getImageIconSize, IMAGE_IN_DISPLAY_SIZE, THUMBNAIL_SIZE, IMAGE_THUMBNAIL_SIZE } from "../images";
...
export default {
    thumbnailsOutline: {
        circleRadius: Math.round(THUMBNAIL_SIZE / 2),
    ...
    thumbnailsHighlightOutline: {
        circleRadius: Math.round(THUMBNAIL_SIZE / 2) * 1.1,
        circleColor: 'transparent',
