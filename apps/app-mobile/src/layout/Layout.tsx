...
export const Layout: FC<MachineWardLayoutProps> = ({ children }) => {
    ...
    return (
        <SafeAreaProvider>
            <SafeAreaView style={[styles.safeArea, { backgroundColor: theme.colors.componentsbackground }]}>
                <StatusBar barStyle={theme.themeName === ThemeName.Light ? "dark-content" : "light-content"} />
                <View style={[styles.container, { backgroundColor: theme.colors.componentsbackground }]}>
                    {children}
                </View>
            </SafeAreaView>
        </SafeAreaProvider>
