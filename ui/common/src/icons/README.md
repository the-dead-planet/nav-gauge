...
If it's from The Noun Project, then add it in [the noun project folder index](/ui/common/src/icons/svg/noun-project/index.ts)
...
The Noun Project requires attribution. See how to process icons in [here](/ui/common/src/icons/svg/noun-project/README.md).
